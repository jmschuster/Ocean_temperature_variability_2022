...
for (j in start:finish) {
  ...
  if (length(data$plot_id) > 0) {
    ...
    dbWriteTable(mydb, "daily_br_diff", results, append = TRUE, header = TRUE,
...
for (j in start:finish) {
  ...
  if (length(data$plot_id) > 0) {
    ...
    dbWriteTable(mydb, "weekly_br_diff", results, append = TRUE, header = TRUE,
                 row.names = FALSE, nrows = length(results$plot_id), sep = ",", eol = "\n",
                 skip = 0, quote = "\"")
  }
}
...
for (j in start:finish) {
  ...
  if (length(data$plot_id) > 0) {
    ...
    dbWriteTable(mydb, "biweekly_br_diff", results, append = TRUE, header = TRUE,
                 row.names = FALSE, nrows = length(results$plot_id), sep = ",", eol = "\n",
                 skip = 0, quote = "\"")
  }
}
...
for (j in start:finish) {
  ...
  if (length(data$plot_id) > 0) {
    ...
    dbWriteTable(mydb, "monthly_br_diff", results, append = TRUE, header = TRUE,
                 row.names = FALSE, nrows = length(results$plot_id), sep = ",", eol = "\n",
                 skip = 0, quote = "\"")
  }
}
...
for (j in start:finish) {
  ...
  if (length(data$plot_id) > 0) {
    ...
    dbWriteTable(mydb, "annual_br_diff", results, append = TRUE, header = TRUE,
                 row.names = FALSE, nrows = length(results$plot_id), sep = ",", eol = "\n",
                 skip = 0, quote = "\"")
  }
}
