...
temp_range_annual = read.csv("temp range annual more than 3 years - 19 Mar 23.csv")
temp_range_short_term = read.csv("temp range greater than 3 years - 19 Mar 23.csv")
br_diff_annual = read.csv("br diff e063 annual more than 3 years - 19 Mar 23.csv")
br_diff_short_term = read.csv("br diff e063 more than 3 years - 19 Mar 23.csv")
...
ggsave(filename="FigS2_V4.png",height=5, width=11, units="in", 
