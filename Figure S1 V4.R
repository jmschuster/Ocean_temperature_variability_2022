...
temp_range_annual = read.csv("temp range annual Conservative - 19 Mar 2023.csv")
temp_range_short_term = read.csv("temp range conservative - 19 Mar 2023.csv")
br_diff_annual = read.csv("br diff e063 annual conservative - 19 Mar 2023.csv")
br_diff_short_term = read.csv("br diff e063 conservative - 19 Mar 2023.csv")
...
ggsave(filename="FigS1_V4.png",height=5, width=11, units="in", 
