...
br_diff_short_term$depth_in_m[which(br_diff_short_term$depth_in_m == -99)] = 1.5
br_diff_annual$depth_in_m[which(br_diff_annual$depth_in_m == -99)] = 1.5
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = q_diurnal_median))+
...
ggplot(br_diff_short_term, aes(x = depth_in_m, y = q_diurnal_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$q_diurnal_median == 0) # values equal to 0 - reject
br_diff_short_term$q_diurnal_median[which(br_diff_short_term$q_diurnal_median == 0)] = NA
mod_q_diurnal_median <- brm(q_diurnal_median ~ climate_classification + depth_in_m + 
                              (1|spatial_blocks/plot_id),
                            data = br_diff_short_term, 
...
marginal_effect <- emmeans(mod_q_diurnal_median, ~ climate_classification,
                           at = list(depth_in_m = mean(br_diff_short_term$depth_in_m)),
                           epred = TRUE,
                           level = 0.9)
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = s_diurnal_median))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = s_diurnal_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$s_diurnal_median == 0) # values equal to 0 - reject
br_diff_short_term$s_diurnal_median[which(br_diff_short_term$s_diurnal_median == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = daily_median))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = daily_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$daily_median == 0) # values equal to 0 - reject
br_diff_short_term$daily_median[which(br_diff_short_term$daily_median == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = weekly_median))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = weekly_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$weekly_median == 0) # values equal to 0 - reject
br_diff_short_term$weekly_median[which(br_diff_short_term$weekly_median == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = biweekly_median))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = biweekly_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$biweekly_median == 0) # values equal to 0 - reject
br_diff_short_term$biweekly_median[which(br_diff_short_term$biweekly_median == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = monthly_median))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = monthly_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$monthly_median == 0) # values equal to 0 - reject
br_diff_short_term$monthly_median[which(br_diff_short_term$monthly_median == 0)] = NA
...
## explore data
ggplot(br_diff_annual, aes(x = climate_classification, y = annual_median))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_annual, aes(x = depth_in_m, y = annual_median)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_annual$annual_median == 0) # values equal to 0 - reject
br_diff_annual$annual_median[which(br_diff_annual$annual_median == 0)] = NA
...
marginal_effect <- emmeans(mod_annual_median, ~ climate_classification,
                           at = list(depth_in_m = mean(br_diff_annual$depth_in_m)),
                           epred = TRUE,
                           level = 0.9)
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = q_diurnal_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = q_diurnal_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$q_diurnal_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_short_term$q_diurnal_ninetieth_perc[which(br_diff_short_term$q_diurnal_ninetieth_perc == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = s_diurnal_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = s_diurnal_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$s_diurnal_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_short_term$s_diurnal_ninetieth_perc[which(br_diff_short_term$s_diurnal_ninetieth_perc == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = daily_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = daily_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$daily_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_short_term$daily_ninetieth_perc[which(br_diff_short_term$daily_ninetieth_perc == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = weekly_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = weekly_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$weekly_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_short_term$weekly_ninetieth_perc[which(br_diff_short_term$weekly_ninetieth_perc == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = biweekly_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = biweekly_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$biweekly_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_short_term$biweekly_ninetieth_perc[which(br_diff_short_term$biweekly_ninetieth_perc == 0)] = NA
...
## explore data
ggplot(br_diff_short_term, aes(x = climate_classification, y = monthly_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_short_term, aes(x = depth_in_m, y = monthly_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_short_term$monthly_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_short_term$monthly_ninetieth_perc[which(br_diff_short_term$monthly_ninetieth_perc == 0)] = NA
...
## explore data
ggplot(br_diff_annual, aes(x = climate_classification, y = annual_ninetieth_perc))+
  geom_half_point(aes(color = climate_classification),
                  transformation = position_quasirandom(width = 0.1),
                  side = "l", size = 1, alpha = 0.5)+
  geom_half_boxplot(aes(fill = climate_classification), side = 'r')

ggplot(br_diff_annual, aes(x = depth_in_m, y = annual_ninetieth_perc)) +
  geom_point(aes(color = climate_classification)) +
  geom_smooth(method = "lm")


# model brms with simple flat priors (default) and nested random effects
which(br_diff_annual$annual_ninetieth_perc == 0) # values equal to 0 - reject
br_diff_annual$annual_ninetieth_perc[which(br_diff_annual$annual_ninetieth_perc == 0)] = NA
...
# Save all objects 
# save.image(file = "all_br_diff_models.RData")
...
ggsave(filename="Fig_S12.png",height=5, width=11, units="in", 
       plot=grid.arrange(check_fit_q_diurnal_median, check_fit_s_diurnal_median, 
                         check_fit_daily_median, check_fit_weekly_median, 
                         check_fit_biweekly_median, check_fit_monthly_median, 
                         check_fit_annual_median, as_ggplot(legend2),
                         ncol = 4), device="png")

ggsave(filename="Fig_S14.png",height=5, width=11, units="in", 
       plot=grid.arrange(check_fit_q_diurnal_ninetieth_perc, check_fit_s_diurnal_ninetieth_perc, 
                         check_fit_daily_ninetieth_perc, check_fit_weekly_ninetieth_perc, 
                         check_fit_biweekly_ninetieth_perc, check_fit_monthly_ninetieth_perc, 
                         check_fit_annual_ninetieth_perc, as_ggplot(legend2),
                         ncol = 4), device="png")

ggsave(filename="br_diff_median.png",height=5, width=11, units="in", 
...
ggsave(filename="br_diff_ninetieth_perc.png",height=5, width=11, units="in", 
