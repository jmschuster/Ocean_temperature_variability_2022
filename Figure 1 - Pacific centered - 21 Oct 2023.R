...
# rm(list = ls())
setwd("G:/Other computers/My Laptop/Documents/HOTS Database/Final Paper/RMarkDown")
...
assign(paste0("plot1"), ggplot(df, aes(x = time1, y = temp)) + geom_line(colour='#FC440F') + theme_classic() + 
         ...
         annotation_custom(grobTree(textGrob("Daily median: 2.72 °C & Monthly median: 7.70 °C", x=0.55,  y=0.12,
                                             gp=gpar(fontsize=10)))) + 
...
assign(paste0("plot2"), ggplot(df, aes(x = time2, y = temp)) + geom_line(colour='#FC440F') + theme_classic() + 
         ...
         annotation_custom(grobTree(textGrob("b", x=0.08,  y=0.92,
                                             gp=gpar(fontsize=15,fontface='bold')))) + 
         annotation_custom(grobTree(textGrob("Daily median: 0.33 °C & Monthly median: 1.92 °C", x=0.55,  y=0.12,
                                             gp=gpar(fontsize=10)))) + 
...
assign(paste0("plot3"), ggplot(df, aes(x = time3, y = temp)) + geom_line(colour='#E8C547') + theme_classic() + 
         ...
         annotation_custom(grobTree(textGrob("c", x=0.08,  y=0.92,
                                             gp=gpar(fontsize=15,fontface='bold')))) + 
         annotation_custom(grobTree(textGrob("Daily median: 0.76 °C & Monthly median: 4.76 °C", x=0.55,  y=0.12,
                                             gp=gpar(fontsize=10)))) + 
...
assign(paste0("plot4"), ggplot(df, aes(x = time4, y = temp)) + geom_line(colour='#E8C547') + theme_classic() + 
         labs(title = "Australia (20.90°S, 10 mins)") + geom_hline(yintercept=31.3002,
                                                                  linetype='dashed')+ 
         ...
         annotation_custom(grobTree(textGrob("d", x=0.08,  y=0.92,
                                             gp=gpar(fontsize=15,fontface='bold')))) + 
         annotation_custom(grobTree(textGrob("Daily median: 0.59 °C & Monthly median: 2.49 °C", x=0.55,  y=0.12,
                                             gp=gpar(fontsize=10)))) + 
...
assign(paste0("plot5"), ggplot(df, aes(x = time5, y = temp)) + geom_line(colour="#50D8D7") + theme_classic() + 
         labs(title = "Tasmania (43.23°S, 60 mins)") + geom_hline(yintercept=20.793,
                                                         linetype='dashed')+ 
...
assign(paste0("plot6"), ggplot(df, aes(x = as.Date(time6), y = temp)) + geom_line(colour="#50D8D7") + theme_classic() + 
         labs(title = "Chile (41.50°S, 60 mins)") + geom_hline(yintercept=21.71,
                                                      linetype='dashed')+ 
